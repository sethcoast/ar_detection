...
def add_ar_tag_to_img(img):
    ...
    mult = random.randint(1, int(max_sz/7))

    # i need to put the image outside the frame
    # think of ar tag in terms of center
    ...
    # There is a problem with the integer division, in some cases the stuff is too large, in others too big
...
def main():
    ...
    # no longer necessary
    img = cv2.imread('../testSet_resize/'+img_name,)
